...
class StreamHolder extends React.Component {
        ...
        <Motion 
            ...
            style={{opacity: spring(this.state.stream ? 1 : 0, {stiffness: 50})}}
        >
            {(style) => (
         ...
         <Motion 
            defaultStyle={{opacity: 0}}
            style={{opacity: spring(this.state.ocean ? 1 : 0, {stiffness: 50})}}
        >
            {(style) => (
                <div  style={{opacity: style.opacity}}>
         ...
         <Motion 
            defaultStyle={{opacity: 0}}
            style={{opacity: spring(this.state.archive ? 1 : 0, {stiffness: 50})}}
        >
            {(style) => (
                <div  style={{opacity: style.opacity}}>
